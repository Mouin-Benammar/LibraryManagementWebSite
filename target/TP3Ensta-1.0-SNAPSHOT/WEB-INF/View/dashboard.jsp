      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>${nombre_membres}</h3> <!-- TODO : afficher le nombre de membres à la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>${nombre_livres}</h3> <!-- TODO : afficher le nombre de livres à la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3> ${nombre_emprunts} </h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
	          ...
	          <table class="striped">
                ...
                <tbody id="results">
                         ...
                         <tr>
                                ...
                                <td>${f.dateEmprunt} </td>
                                <td><a href="emprunt_return?id=${f.id}"><ion-icon class="table-item" name="log-in"></a></td>
                      	</tr>
                        </c:forEach>
