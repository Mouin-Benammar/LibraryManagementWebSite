  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du membre n°${id}</h5> <!-- TODO : remplacer 312 par l'id du membre -->
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer la fiche de  ${prenom}  ${nom} ?</p> <!-- TODO : remplacer prenomDuMembre et nomDuMembre par les valeurs correspondantes -->
	      <form action="/TP3Ensta/membre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/TP3Esnta/membre_details?id=${id}">Annuler</a> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        </div>
	      </form>
	    </div>	    
      </div>
